...
import de.muspellheim.datenverteiler.datenkatalog.DatenkatalogMatchers;
import de.muspellheim.datenverteiler.datenkatalog.modell.*;
...
public class BindingIT extends AbstractDatenkatalogIT {
    ...
    public void testBinding_Aufzaehlungstyp_Objektreferenz() {
        ...
        assertThat(actualData, CoreMatchers.is(DatenkatalogMatchers.dataEqualsTo(data)));
